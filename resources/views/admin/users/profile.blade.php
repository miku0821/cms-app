        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                @method('PUT')
                    ...
                    <div class="mb-3">
                        <img class="img-profile rounded-circle" src="@if ($user->avatar == NULL) https://www.business2community.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640.png @else {{$user->avatar}} @endif" alt="" width="60" height="60">
                    </div>
