                ...
                <table class="table table-bordered" id="usersTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$user->name}}</td>
                      <td><img src="@if ($user->avatar == NULL) https://www.business2community.com/wp-content/uploads/2017/08/blank-profile-picture-973460_640.png @else data:image/png;base64,{{auth()->user()->avatar}} @endif" alt="" width=60 height=60></td>
                      <td>{{$user->email}}</td>
